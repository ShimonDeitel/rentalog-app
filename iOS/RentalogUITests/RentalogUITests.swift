...
final class RentalogUITests: XCTestCase {
    ...
    func testAddEntryFlow() throws {
        ...
        nameField.tap()
        nameField.typeText("UI Test Customer")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Customer"].waitForExistence(timeout: 2))
    }
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 3) || app.staticTexts["Rentalog Pro"].waitForExistence(timeout: 2))
    }
